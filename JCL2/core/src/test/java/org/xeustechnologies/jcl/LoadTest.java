    ...
    extends TestCase
{
    ...
    private static final String TARGET_TEST_JAR = "target/dependency/test-jcl.jar";
    ...
    {
        JarClassLoader jc = new JarClassLoader( new String[] { TARGET_TEST_JAR } );
    ...
    @Test
    public void testWithClassFolder()
        throws InstantiationException, IllegalAccessException, ClassNotFoundException
    {
        JarClassLoader jc = new JarClassLoader( new String[] { TARGET_TEST_JAR } );
            ...
            ClassNotFoundException
    {
        ...
        File f = new File( TARGET_TEST_JAR );
    ...
    public void testWithInputStream()
        throws InstantiationException, IllegalAccessException, ClassNotFoundException,
            IOException
    {
        FileInputStream fis = new FileInputStream( TARGET_TEST_JAR );
    ...
    @Test
    public void testAddingClassSources()
        throws InstantiationException, IllegalAccessException, ClassNotFoundException
    {
        JarClassLoader jc = new JarClassLoader();
        jc.add( TARGET_TEST_JAR );
        Object testObj = jc.loadClass( "org.xeustechnologies.jcl.test.Test" ).newInstance();
        assertNotNull( testObj );
    }

    @Test
    public void testChangeClassLoadingOrder()
    ...
    @Test
    public void testOsgiBootLoading()
    ...
    @Test
    public void testXmlContextLoader()
        throws ClassNotFoundException
    {
    ...
    @Test
    public void testDefaultContextLoader()
        throws InstantiationException, IllegalAccessException,
            ClassNotFoundException
    {
        JarClassLoader jc = new JarClassLoader( new String[] { TARGET_TEST_JAR } );
